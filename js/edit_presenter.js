...
cm.EditPresenter = function(appState, mapModel, arranger, opt_config) {
  ...
  cm.events.listen(goog.global, cm.events.INSPECT, function(e) {
    if (e.object instanceof cm.MapModel) {
      inspector.inspect(e.object, 'Edit map details', [
      ...
      inspector.inspect(e.object, 'Edit layer details', [
  ...
  // The user has requested to create a layer or folder.
  cm.events.listen(goog.global, cm.events.CREATE_LAYERS, function(e) {
    this.doCommand(new cm.CreateLayersCommand(e.maproots), appState,
        mapModel);
  }, this);
