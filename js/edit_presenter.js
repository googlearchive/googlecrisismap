...
cm.EditPresenter = function(appState, mapModel, arranger, opt_config) {
  ...
  var layerTypeChoices = [
    ...
    {value: cm.LayerModel.Type.TILE,
     label: cm.UNTRANSLATED_MSG_LAYER_TYPE_TILE_SERVICE},
  ...
  var layerFields = [
    ...
    {key: 'viewport', label: cm.UNTRANSLATED_MSG_LAYER_VIEWPORT,
     type: cm.editors.Type.LAT_LON_BOX, app_state: appState,
    ...
    {key: 'url', label: cm.MSG_SOURCE_URL, type: cm.editors.Type.TEXT,
     ...
     tooltip: cm.UNTRANSLATED_MSG_SOURCE_URL_TOOLTIP},
    ...
    {key: 'url_is_tile_index', label: cm.UNTRANSLATED_MSG_TILE_INDEX,
     type: cm.editors.Type.CHECKBOX, checked_value: true,
     unchecked_value: false,
     conditions: {'type': isType(cm.LayerModel.Type.TILE)},
     tooltip: cm.UNTRANSLATED_MSG_TILE_INDEX_TOOLTIP},
    ...
    {key: 'ft_where', label: cm.UNTRANSLATED_MSG_GFT_FILTER_CONDITION,
     type: cm.editors.Type.TEXT,
     conditions: {'type': isType(cm.LayerModel.Type.FUSION)},
     tooltip: cm.UNTRANSLATED_MSG_GFT_FILTER_CONDITION_TOOLTIP},
    ...
    {key: 'tile_coordinate_type',
     label: cm.UNTRANSLATED_MSG_TILE_COORDINATE_TYPE,
     type: cm.editors.Type.MENU,
     conditions: {'type': isType(cm.LayerModel.Type.TILE)},
     choices: [
       {value: cm.LayerModel.TileCoordinateType.GOOGLE,
        label: cm.UNTRANSLATED_MSG_GOOGLE_MAPS_COORDINATES},
       {value: cm.LayerModel.TileCoordinateType.BING,
        label: cm.UNTRANSLATED_MSG_BING_MAPS_QUADKEYS},
       {value: cm.LayerModel.TileCoordinateType.TMS,
        label: cm.UNTRANSLATED_MSG_TMS_COORDINATES}],
     tooltip: cm.UNTRANSLATED_MSG_TILE_COORDINATE_TYPE_TOOLTIP},
    {key: 'folder_type', label: cm.UNTRANSLATED_MSG_FOLDER_TYPE,
      type: cm.editors.Type.MENU,
      choices: [
        {value: cm.LayerModel.FolderType.UNLOCKED,
         label: cm.UNTRANSLATED_MSG_FOLDER_TYPE_UNLOCKED},
        {value: cm.LayerModel.FolderType.LOCKED,
         label: cm.UNTRANSLATED_MSG_FOLDER_TYPE_LOCKED},
        {value: cm.LayerModel.FolderType.SINGLE_SELECT,
         label: cm.UNTRANSLATED_MSG_FOLDER_TYPE_SINGLE_SELECT}
      ],
     conditions: {'type': isType(cm.LayerModel.Type.FOLDER)},
     tooltip: cm.UNTRANSLATED_MSG_FOLDER_TYPE_TOOLTIP}
 ];
