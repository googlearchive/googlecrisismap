...
EXTERNALS=external/css.js external/google_maps_api_v3.js external/html4-defs.js external/html-sanitizer.js external/maps_api.js
...
clean:
	...
	rm -rf static/mapviewer.css static/json_files.js external/css.js
	rm -rf $(OUT_DIR)
