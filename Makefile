...
EXTERNALS=external/google_maps_api_v3_11.js external/html4-defs.js external/html-sanitizer.js external/maps_api.js external/uri.js
...
external/google_maps_api_v3_11.js:
	@mkdir -p external
...
$(OUT_OPT): $(EXTERNALS) $(OUT_DIR)/css.js js/*.js
	...
	python $(CLOSURE_DIR)/closure/bin/calcdeps.py \
	    ...
	    -f --externs=external/google_maps_api_v3_11.js \
	    > $@
