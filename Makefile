...
TEST_DEPS=aux/json_files.js,js/test_utils.js,$(CLOSURE_DIR)/closure/goog/testing/events/events.js,$(CLOSURE_DIR)/closure/goog/testing/objectpropertystring.js,$(CLOSURE_DIR)/closure/goog/testing/propertyreplacer.js,$(CLOSURE_DIR)/closure/goog/testing/watchers.js,$(CLOSURE_DIR)/closure/goog/testing/mockclock.js
...
# Concatenate all the CSS files, putting all the @import lines first.
static/mapviewer.css: resource/*.css
	cat $^ | grep '@import' > $@ || true
	cat $^ | grep -v '@import' >> $@ || true
