...
class UsersTest(test_utils.BaseTest):
  ...
  def testGetCurrent_ImpersonationNotAllowed(self):
    ...
    with test_utils.EnvContext(
        ...
        USER_EMAIL='alice@alpha.test', USER_ORGANIZATION='alpha.test',
